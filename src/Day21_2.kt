...
private fun getShortestKeypadPath(start: KeypadKey, end: KeypadKey): List<DirectionPadKey> = when (start to end) {
    ...
    KeypadKey.ONE to KeypadKey.TWO -> listOf(
    ...
    KeypadKey.ONE to KeypadKey.A -> listOf(
        DirectionPadKey.RIGHT,
        DirectionPadKey.RIGHT,
    ...
    KeypadKey.THREE to KeypadKey.FOUR -> listOf(
        DirectionPadKey.LEFT,
        DirectionPadKey.LEFT,
        DirectionPadKey.UP,
        DirectionPadKey.A
    ...
    KeypadKey.FOUR to KeypadKey.ZERO -> listOf(
        DirectionPadKey.RIGHT,
        DirectionPadKey.DOWN,
        DirectionPadKey.DOWN,
        DirectionPadKey.A
    ...
    KeypadKey.FOUR to KeypadKey.SIX -> listOf(
        DirectionPadKey.RIGHT, DirectionPadKey.RIGHT, DirectionPadKey.A
    )
...
fun solve(input: List<String>): String = input
    .sumOf(::getComplexity)
    .toString()
